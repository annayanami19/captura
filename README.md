...
2. Klik **Load unpacked** → pilih folder repo ini (yang berisi `manifest.json`).
3. Ikon Captura muncul di toolbar — siap dipakai! 🎉

> Sudah pernah install versi lama? **Remove** dulu, lalu Load unpacked ulang.
